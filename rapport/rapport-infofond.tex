...
\section{Q11}
Un problème est NP-complet est NP-dur par définition. En effet, comme montré sur l'image suivante NP-complet est un sous-ensemble de NP-dur.
\begin{figure}[H]
  \centering
...
Lors de ce projet nous avons reduit le problème d'emploi de temps en un problème SAT.
